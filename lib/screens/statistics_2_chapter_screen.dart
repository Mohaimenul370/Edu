...
class _Statistics2ChapterScreenState extends State<Statistics2ChapterScreen> {
  ...
  Future<void> _loadScore() async {
    ...
    final score = SharedPreferenceService.getGamePercentage('statistics_2');
    if (mounted) {
      setState(() {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildModeCard(
                ...
                () => Navigator.pushNamed(context, '/statistics_2/learn'),
              ),
              ...
              _buildModeCard(
                ...
                () async {
                  await Navigator.pushNamed(context, '/statistics_2/game');
                  _loadScore();
                },
              ),
              const Spacer(),
